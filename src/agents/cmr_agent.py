...
- Use the search_collections is for dataset discovery.
- When using the search_collections, the parameter keyword should only have a single word passed onto it as keyword
- Use the search_granules endpoint for file-level searches
- Support key parameters:
